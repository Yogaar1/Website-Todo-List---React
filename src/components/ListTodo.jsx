...
const ListTodo = ({setInput}) => {
    ...
    const nonActiveClass = "py-1 px-3 bg-slate-800 rounded-2xl text-white hover:bg-gray-700";

    const activeClass = "py-1 px-3 bg-orange-400 hover:bg-orange-500 rounded-2xl text-white";
                            ...
                            todos.length > 0
                                ? (todos.map((item) => (
                                    <li
                                        ...
                                        <p
                                            className={"grow text-xl cursor-pointer text-slate-700" + (
                                                item.completed
                                                    ? " line-through"
                                                    : ""
                                            )}
